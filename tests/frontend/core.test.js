  ...
  it('defines all required state variables', () => {
    const result = JSON.parse(vm.runInContext(`
      JSON.stringify({
        ...
        modelCenterFilter: modelCenterFilter === 'all',
        modelRoles: typeof modelRoles === 'object',
        providerTableCollapsed: typeof providerTableCollapsed === 'object',
    ...
    assert(result.modelRoles);
    assert(result.providerTableCollapsed);
