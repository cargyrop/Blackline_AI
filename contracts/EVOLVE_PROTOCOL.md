...
```json
[
  { "path": "public/modules/models.js", "action": "edit", "description": "Add favoriteIds Set to state; add toggleFavorite(modelId) and isFavorite(modelId) helpers." },
  { "path": "public/modules/settings.js", "action": "edit", "description": "Add 'Favorites' section to Model Center with unfavorite buttons." }
]
```
